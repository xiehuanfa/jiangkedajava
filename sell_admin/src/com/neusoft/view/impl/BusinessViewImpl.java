...
public class BusinessViewImpl implements BusinessView {
    ...
    @Override
    public  void getBusinessById(Integer businessId){
        BusinessDaoImpl dao = new BusinessDaoImpl();
        Business b = dao.getBusinessById(businessId);
        if(b==null){
            System.out.println("商家已经被删除了");
        }else {
            System.out.println("商家编号" + "\t" + "商家名称" + "\t" + "商家地址" + "\t" + "商家备注" + "\t" + "商家配送费" + "\t" + "商家起送费");
            System.out.println(b.getBusinessId() + "\t" + b.getBusinessName() + "\t" + b.getBusinessAddress() + "\t" + b.getBusinessExplain() + "\t" + b.getDeliveryPrice() + "\t" + b.getStartPrice());
        }
    ...
    public void updateBusiness(Integer businessId){
        ...
        if(b==null){
            ...
            System.out.println("请输入新商家的名称");
            b.setBusinessName(input.next());
            System.out.println("请输入新商家的地址");
            b.setBusinessAddress(input.next());
            System.out.println("请输入新商家的备注");
            b.setBusinessExplain(input.next());
            System.out.println("请输入新商家的配送费");
            b.setDeliveryPrice( input.nextDouble());
            System.out.println("请输入新商家的起送费");
            b.setStartPrice(input.nextDouble());
            int ret =  dao.updateBusiness(b);
            // 保存成功
            if (ret > 0) {
                System.out.println("保存成功");
            } else {
